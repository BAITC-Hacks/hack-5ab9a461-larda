...
При уже запущенном Docker API на 8080 установите Node.js 22 и выполните:
...
Попробуйте запустить `SEED_DEMO=false` для тестирования с пустой бд. Иначи mock данные могут мешать.
